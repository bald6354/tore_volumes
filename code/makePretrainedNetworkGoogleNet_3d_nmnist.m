...
tempLayers = [
    ...
    fullyConnectedLayer(20,"Name","fc_1","BiasLearnRateFactor",10,"WeightLearnRateFactor",10)
    fullyConnectedLayer(10,"Name","fc_2","BiasLearnRateFactor",10,"WeightLearnRateFactor",10)
